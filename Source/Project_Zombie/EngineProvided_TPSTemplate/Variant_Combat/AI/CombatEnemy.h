...
#include "EngineProvided_TPSTemplate/Variant_Combat/Interfaces/CombatAttacker.h"
#include "EngineProvided_TPSTemplate/Variant_Combat/Interfaces/CombatDamageable.h"
